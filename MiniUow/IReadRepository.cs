...
namespace MiniUow
{
    public interface IReadRepository<T> where T : class
    {
        ...
        /// <summary>
        /// Gets the Any based on a predicate.
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Finds an entity with the given primary key values. If found, is attached to the context
        /// and returned. If no entity is found, then null is returned.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// A <see cref="Task{T}"/> that represents the asynchronous find operation. The task result
        /// contains the found entity or null.
        /// </returns>
        ...
        /// <summary>
        /// Gets the first or default entity based on a predicate, orderby delegate and include
        /// delegate. This method defaults to a read-only, no-tracking query.
        /// </summary>
        ...
        /// <returns>
        /// An <see cref="IPagedList{T}"/> that contains elements that satisfy the condition
        ...
        /// <summary>
        /// Gets the first or default entity based on a predicate, orderby delegate and include
        /// delegate. This method default no-tracking query.
        /// </summary>
        /// <param name="predicate"></param>
        ...
        /// Gets the first or default entity based on a predicate, orderby delegate and include
        /// </summary>
        /// <param name="predicate">Predicate dynammic</param>
        /// <param name="orderBy">OrderBy dynammic</param>
        /// <param name="include"></param>
        /// <param name="disableTracking"></param>
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        T FirstOrDefault(string predicate = null,
          string orderBy = null,
          Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
          bool disableTracking = true, bool ignoreQueryFilters = false);
        ...
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        Task<T> FirstOrDefaultAsync(string predicate = null,
            string orderBy = null,
            Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
            bool disableTracking = true,
        ...
        /// Gets all entities.
        /// </summary>
        /// <param name="predicate">Predicate Dynamic</param>
        /// <param name="orderBy">OrderBy Dynamic</param>
        /// <param name="include"></param>
        /// <param name="disableTracking"></param>
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        IQueryable<T> GetAll(string predicate = null,
        string orderBy = null,
         Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
         bool disableTracking = true,
         bool ignoreQueryFilters = false);
        ...
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        Task<IQueryable<T>> GetAllAsync(string predicate = null,
            string orderBy = null,
            Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
            bool disableTracking = true,
            bool ignoreQueryFilters = false);
        ...
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        Task<IQueryable<TResult>> GetAllAsync<TResult>(Expression<Func<T, TResult>> selector, string predicate = null,
         string orderBy = null,
         Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
         bool disableTracking = true,
         bool ignoreQueryFilters = false) where TResult : class;
        ...
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        IPaginate<T> GetPagedList(string predicate = null,
          string orderBy = null,
        ...
        /// <param name="ignoreQueryFilters"></param>
        /// <returns></returns>
        Task<IPaginate<T>> GetPagedListAsync(string predicate = null,
           string orderBy = null,
           Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null,
           int index = 0,
           int size = 20,
